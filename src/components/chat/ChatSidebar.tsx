...
import { Edit, MessageSquare, MoreHorizontal, Plus, Star, Trash2, User } from "lucide-react"
...
const chatThreads: IChatThread[] = [
  { id: "1", title: "Safe Async Error Handling in Type...", timestamp: "2 hours ago" },
  { id: "2", title: "Loom Video Project Showcase Em...", timestamp: "1 day ago" },
  { id: "3", title: "Student Codeforces Analytics Das...", timestamp: "2 days ago" },
  { id: "4", title: "Untitled", timestamp: "3 days ago" },
  { id: "5", title: "Mongoose Cron Job Email Schedul...", timestamp: "1 week ago" },
  { id: "6", title: "Mongoose Email Template TypeSc...", timestamp: "1 week ago" },
  { id: "7", title: "React Sidebar Link Component", timestamp: "2 weeks ago" },
  { id: "8", title: "React Dashboard Student Data Fe...", timestamp: "2 weeks ago" },
  { id: "9", title: "TypeScript Student ID Type Error", timestamp: "3 weeks ago" },
  { id: "10", title: "UI Animation Enhancement Guide", timestamp: "3 weeks ago" },
]

const ChatThread = ({ data, starredChats, onStarChat, onDeleteChat, onRenameChat }: {
  data: IChatThread
    ...
    <Sidebar className="border-r border-border/40 bg-sidebar">
      ...
      <SidebarContent className="p-2">
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              {state === "expanded" && chatThreads.map((data) => (
                <ChatThread 
                  key={data.id}
                  data={data}
              ...
              <DropdownMenuTrigger asChild>
                <SidebarMenuButton className="w-full justify-start">
                  <Avatar className="h-6 w-6">
                    <AvatarFallback className="bg-primary text-white text-xs">RG</AvatarFallback>
                  </Avatar>
                  {state === "expanded" && (
