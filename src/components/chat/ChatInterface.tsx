...
const ChatInterface = ({ selectedScene }: ChatInterfaceProps) => {
	const [chat, setChat] = useState<IChat[]>([
		{
			...
			ai: {
				message:
					'Hi, I am an AI assistant here to help you. What can I do for you today?',
			},
		},
		{
			userChat: {
		...
		<div className="flex flex-col h-full ">
			<div className="flex items-center justify-between p-4 border-b">
				<div className="flex items-center gap-2">
					...
					{selectedScene && (
						<Badge variant="secondary">@Scene {selectedScene} selected</Badge>
					)}
				</div>
			</div>
				...
				<div className="border rounded-lg p-3 bg-muted/30">
					<div className="flex items-end gap-2 bg-muted/40  rounded-lg p-2">
						<textarea
							placeholder={
								selectedScene
									? `Prompt for Scene ${selectedScene}...`
									: 'Type your message...'
							}
